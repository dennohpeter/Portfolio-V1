...
/***/ (function(module, exports) {
	...
	var Jello = function () {
	  ...
	  function Jello() {
	    ...
	    this.imageCounter = 0;
	    this.displacementSprite = PIXI.Sprite.fromImage("static/images/distortion/dmap-clouds-01.jpg");
	  ...
	  _createClass(Jello, [{
	    ...
	    value: function changeMap() {
	      ...
	      this.displacementSprite = PIXI.Sprite.fromImage("static/images/distortion/" + this.currentMap.image);
	      this.displacementFilter = new PIXI.filters.DisplacementFilter(this.displacementSprite);
	      this.createFilters();
	    }
	    ...
	    value: function createBackgrounds() {
	      ...
	      this.bgArray.map(function (image) {
	        var bg = PIXI.Sprite.fromImage("static/images/bg/"+image+ ".jpg");
